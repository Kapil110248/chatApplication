  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (error.response?.status === 403) {
        toast.error("❌ Ye account pehle se kisi aur device me login hai.");
      ...
      >
        ...
        <div className="flex justify-center">
          <input
            ...
            disabled={loading}
            className="text-white bg-blue-600 cursor-pointer w-full rounded-lg py-2 disabled:opacity-50"
          />
        </div>
